...
#Items
item = {
     'gun': Item("Gun", "The toolie"),  
    'shield': Item("Shield", "He protecc"),
    'arrows': Item("Arrows", "Pointy sticc"),
    'sword': Item("Sword", "Sharp sticc"),
    'bow': Item('Bow', 'Ehhh'),
    'axe': Item("Axe", "Choppy"),
    'health': Item("Health Potion", "The big healer")
}
room = {
    'outside':  Room("Outside Cave Entrance", "North of you, the cave mount beckons", item['axe']),
...
player = Player("Cheems", room["outside"])
